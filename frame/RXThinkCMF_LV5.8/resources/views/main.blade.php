        ...
        <div class="layui-col-sm6" style="padding-bottom: 0;">
            <div class="layui-row layui-col-space15">
                <div class="layui-col-xs6 layui-col-sm3">
                    <div class="console-app-group" ew-href="/user/index" ew-title="用户管理">
                ...
                <div class="layui-card-body">
                    <table class="layui-table layui-text">
                        ...
                        <script type="text/html" ew-tpl>
                            <tr>
                                <td>当前版本</td>
                                <td>{{$version}} &emsp; <a href="https://docs.laravel.rxthinnk.cn" target="_blank">更新日志</a>
                                </td>
                            </tr>
                            <tr>
                                <td>基于框架</td>
                        ...
                        <tr>
                            <td>获取渠道</td>
                            <td>
                                <a href="tencent://message/?uin=1175401194" class="layui-btn layui-btn-sm layui-btn-danger"
                                   target="_blank">获取授权</a>
                                <a href="http://www.rxthink.cn" target="_blank" class="layui-btn layui-btn-sm">立即下载</a>
                            </td>
                        </tr>
                        </tbody>
                    </table>
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <div class="console-user-group">
                        <img src="/static/admin/assets/images/head.jpg" class="console-user-group-head" alt=""/>
